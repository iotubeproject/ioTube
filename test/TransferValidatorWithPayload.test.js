const TransferValidator = artifacts.require('TransferValidatorWithPayload');
...
const CrosschainERC20 = artifacts.require('CrosschainERC20V2');
...
contract('TransferValidatorWithPayload', function([owner, minter, sender, relayer, cashier, receiver]) {
    beforeEach(async function() {
        this.witnessList = await WitnessList.new();
        this.validator = await TransferValidator.new(this.witnessList.address);
        this.unwrapper = await Unwrapper.new("0x0000000000000000000000000000000000000000");
    ...
    it('is not receiver', async function() {
        ...
        assert.equal(tx.logs[0].args.witnesses[0], this.witnesses[0].address);
    })
    it('is receiver', async function() {
