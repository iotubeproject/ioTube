...
// GetWitnessLists is a free data retrieval call binding the contract method 0xe847d1f2.
//
// Solidity: function getWitnessLists(address tokenAddr) view returns(address[])
func (_TransferValidatorV3 *TransferValidatorV3Caller) GetWitnessLists(opts *bind.CallOpts, tokenAddr common.Address) ([]common.Address, error) {
	var out []interface{}
	err := _TransferValidatorV3.contract.Call(opts, &out, "getWitnessLists", tokenAddr)
...
//
// Solidity: function getWitnessLists(address tokenAddr) view returns(address[])
func (_TransferValidatorV3 *TransferValidatorV3Session) GetWitnessLists(tokenAddr common.Address) ([]common.Address, error) {
	return _TransferValidatorV3.Contract.GetWitnessLists(&_TransferValidatorV3.CallOpts, tokenAddr)
}

// GetWitnessLists is a free data retrieval call binding the contract method 0xe847d1f2.
//
// Solidity: function getWitnessLists(address tokenAddr) view returns(address[])
func (_TransferValidatorV3 *TransferValidatorV3CallerSession) GetWitnessLists(tokenAddr common.Address) ([]common.Address, error) {
	return _TransferValidatorV3.Contract.GetWitnessLists(&_TransferValidatorV3.CallOpts, tokenAddr)
}
...
// Submit is a paid mutator transaction binding the contract method 0xfbbca895.
//
// Solidity: function submit(address cashier, address tokenAddr, uint256 index, address from, address to, uint256 amount, bytes[] signaturesArray, bytes payload) returns()
func (_TransferValidatorV3 *TransferValidatorV3Transactor) Submit(opts *bind.TransactOpts, cashier common.Address, tokenAddr common.Address, index *big.Int, from common.Address, to common.Address, amount *big.Int, signaturesArray [][]byte, payload []byte) (*types.Transaction, error) {
	return _TransferValidatorV3.contract.Transact(opts, "submit", cashier, tokenAddr, index, from, to, amount, signaturesArray, payload)
}

// Submit is a paid mutator transaction binding the contract method 0xfbbca895.
//
// Solidity: function submit(address cashier, address tokenAddr, uint256 index, address from, address to, uint256 amount, bytes[] signaturesArray, bytes payload) returns()
func (_TransferValidatorV3 *TransferValidatorV3Session) Submit(cashier common.Address, tokenAddr common.Address, index *big.Int, from common.Address, to common.Address, amount *big.Int, signaturesArray [][]byte, payload []byte) (*types.Transaction, error) {
	return _TransferValidatorV3.Contract.Submit(&_TransferValidatorV3.TransactOpts, cashier, tokenAddr, index, from, to, amount, signaturesArray, payload)
}

// Submit is a paid mutator transaction binding the contract method 0xfbbca895.
//
// Solidity: function submit(address cashier, address tokenAddr, uint256 index, address from, address to, uint256 amount, bytes[] signaturesArray, bytes payload) returns()
func (_TransferValidatorV3 *TransferValidatorV3TransactorSession) Submit(cashier common.Address, tokenAddr common.Address, index *big.Int, from common.Address, to common.Address, amount *big.Int, signaturesArray [][]byte, payload []byte) (*types.Transaction, error) {
	return _TransferValidatorV3.Contract.Submit(&_TransferValidatorV3.TransactOpts, cashier, tokenAddr, index, from, to, amount, signaturesArray, payload)
}
