...
// GenerateKey is a free data retrieval call binding the contract method 0xbafca875.
//
// Solidity: function generateKey(bytes cashier, address tokenAddr, uint256 index, bytes from, address to, uint256 amount) view returns(bytes32)
func (_TransferValidator *TransferValidatorCaller) GenerateKey(opts *bind.CallOpts, cashier []byte, tokenAddr common.Address, index *big.Int, from []byte, to common.Address, amount *big.Int) ([32]byte, error) {
	var out []interface{}
...
//
// Solidity: function generateKey(bytes cashier, address tokenAddr, uint256 index, bytes from, address to, uint256 amount) view returns(bytes32)
func (_TransferValidator *TransferValidatorSession) GenerateKey(cashier []byte, tokenAddr common.Address, index *big.Int, from []byte, to common.Address, amount *big.Int) ([32]byte, error) {
...
//
// Solidity: function generateKey(bytes cashier, address tokenAddr, uint256 index, bytes from, address to, uint256 amount) view returns(bytes32)
func (_TransferValidator *TransferValidatorCallerSession) GenerateKey(cashier []byte, tokenAddr common.Address, index *big.Int, from []byte, to common.Address, amount *big.Int) ([32]byte, error) {
	return _TransferValidator.Contract.GenerateKey(&_TransferValidator.CallOpts, cashier, tokenAddr, index, from, to, amount)
}
...
// Submit is a paid mutator transaction binding the contract method 0xed913ef0.
//
// Solidity: function submit(bytes cashier, address tokenAddr, uint256 index, bytes from, address to, uint256 amount, bytes signatures) returns()
func (_TransferValidator *TransferValidatorTransactor) Submit(opts *bind.TransactOpts, cashier []byte, tokenAddr common.Address, index *big.Int, from []byte, to common.Address, amount *big.Int, signatures []byte) (*types.Transaction, error) {
...
//
// Solidity: function submit(bytes cashier, address tokenAddr, uint256 index, bytes from, address to, uint256 amount, bytes signatures) returns()
func (_TransferValidator *TransferValidatorSession) Submit(cashier []byte, tokenAddr common.Address, index *big.Int, from []byte, to common.Address, amount *big.Int, signatures []byte) (*types.Transaction, error) {
...
//
// Solidity: function submit(bytes cashier, address tokenAddr, uint256 index, bytes from, address to, uint256 amount, bytes signatures) returns()
func (_TransferValidator *TransferValidatorTransactorSession) Submit(cashier []byte, tokenAddr common.Address, index *big.Int, from []byte, to common.Address, amount *big.Int, signatures []byte) (*types.Transaction, error) {
	return _TransferValidator.Contract.Submit(&_TransferValidator.TransactOpts, cashier, tokenAddr, index, from, to, amount, signatures)
}

// SubmitMulti is a paid mutator transaction binding the contract method 0x72ea4815.
//
// Solidity: function submitMulti(bytes[] cashiers, address[] tokenAddrs, uint256[] indexes, bytes[] senders, address[] recipients, uint256[] amounts, bytes signatures) returns()
func (_TransferValidator *TransferValidatorTransactor) SubmitMulti(opts *bind.TransactOpts, cashiers [][]byte, tokenAddrs []common.Address, indexes []*big.Int, senders [][]byte, recipients []common.Address, amounts []*big.Int, signatures []byte) (*types.Transaction, error) {
...
//
// Solidity: function submitMulti(bytes[] cashiers, address[] tokenAddrs, uint256[] indexes, bytes[] senders, address[] recipients, uint256[] amounts, bytes signatures) returns()
func (_TransferValidator *TransferValidatorSession) SubmitMulti(cashiers [][]byte, tokenAddrs []common.Address, indexes []*big.Int, senders [][]byte, recipients []common.Address, amounts []*big.Int, signatures []byte) (*types.Transaction, error) {
...
//
// Solidity: function submitMulti(bytes[] cashiers, address[] tokenAddrs, uint256[] indexes, bytes[] senders, address[] recipients, uint256[] amounts, bytes signatures) returns()
func (_TransferValidator *TransferValidatorTransactorSession) SubmitMulti(cashiers [][]byte, tokenAddrs []common.Address, indexes []*big.Int, senders [][]byte, recipients []common.Address, amounts []*big.Int, signatures []byte) (*types.Transaction, error) {
	return _TransferValidator.Contract.SubmitMulti(&_TransferValidator.TransactOpts, cashiers, tokenAddrs, indexes, senders, recipients, amounts, signatures)
}
