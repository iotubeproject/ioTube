...
//
// Solidity: function submit(address tokenAddr, address cashier, uint256 index, address from, address to, uint256 amount, bytes signatures) returns()
func (_TransferValidatorV2 *TransferValidatorV2Transactor) Submit(opts *bind.TransactOpts, tokenAddr common.Address, cashier common.Address, index *big.Int, from common.Address, to common.Address, amount *big.Int, signatures []byte) (*types.Transaction, error) {
	return _TransferValidatorV2.contract.Transact(opts, "submit", tokenAddr, cashier, index, from, to, amount, signatures)
}

// Submit is a paid mutator transaction binding the contract method 0xa9013dce.
//
// Solidity: function submit(address tokenAddr, address cashier, uint256 index, address from, address to, uint256 amount, bytes signatures) returns()
func (_TransferValidatorV2 *TransferValidatorV2Session) Submit(tokenAddr common.Address, cashier common.Address, index *big.Int, from common.Address, to common.Address, amount *big.Int, signatures []byte) (*types.Transaction, error) {
	return _TransferValidatorV2.Contract.Submit(&_TransferValidatorV2.TransactOpts, tokenAddr, cashier, index, from, to, amount, signatures)
}

// Submit is a paid mutator transaction binding the contract method 0xa9013dce.
//
// Solidity: function submit(address tokenAddr, address cashier, uint256 index, address from, address to, uint256 amount, bytes signatures) returns()
func (_TransferValidatorV2 *TransferValidatorV2TransactorSession) Submit(tokenAddr common.Address, cashier common.Address, index *big.Int, from common.Address, to common.Address, amount *big.Int, signatures []byte) (*types.Transaction, error) {
	return _TransferValidatorV2.Contract.Submit(&_TransferValidatorV2.TransactOpts, tokenAddr, cashier, index, from, to, amount, signatures)
}
